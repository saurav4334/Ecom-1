                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="{{url('campaign',$value->slug)}}" class="btn btn-xs btn-primary waves-effect waves-light" target="_blank"><i class="fe-eye"></i></a>
                                    ...
                                    <a href="{{route('campaign.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
