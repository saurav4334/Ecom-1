                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved </span> | <span style="color: white;">Website Designed by: <a href="https://devonicsit.xyz/"><span style="color: white;">Devonics IT</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
