...
<?php $__env->startSection('title','General Setting Create'); ?>
...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('settings.store')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>" name="white_logo" value="<?php echo e(old('white_logo')); ?>"  id="white_logo" required="">
...
unset($__errorArgs, $__bag); ?>" name="favicon" value="<?php echo e(old('favicon')); ?>"  id="favicon" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\backEnd\settings\create.blade.php ENDPATH**/ ?>