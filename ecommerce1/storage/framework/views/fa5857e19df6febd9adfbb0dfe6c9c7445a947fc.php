...
<li>
  ...
  <div class="collapse" id="siebar-sitesetting">
    <ul class="nav-second-level">
      ...
      <li><a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="file-plus"></i> Pixels Setting</a></li>
...
<li>
  ...
  <div class="collapse" id="sidebar-affiliate">
    <ul class="nav-second-level">
      <li><a href="<?php echo e(route('admin.affiliate.dashboard')); ?>"><i data-feather="file-plus"></i> Dashboard</a></li>
      <li><a href="<?php echo e(route('admin.affiliate.index')); ?>"><i data-feather="file-plus"></i> Manage Affiliates</a></li>
      <li><a href="<?php echo e(route('admin.affiliate.applications')); ?>"><i data-feather="file-plus"></i> Applications</a></li>
      <li><a href="<?php echo e(route('admin.affiliate.form_settings')); ?>"><i data-feather="file-plus"></i> Form Settings</a></li>
    </ul>
  </div>
</li>
    ...
    <span>Clear Cache</span>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://devonicsit.xyz/" target="_blank">Website Designed by: Devonics IT</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\backEnd\layouts\master.blade.php ENDPATH**/ ?>