...
@font-face {
    ...
    src: url("<?php echo e(asset('frontEnd/fonts/Potro-Sans-Bangla-Regular.ttf')); ?>");
    src: url("<?php echo e(asset('frontEnd/fonts/Potro-Sans-Bangla-Regular.ttf')); ?>?#iefix") format("embedded-opentype"), url("<?php echo e(asset('frontEnd/fonts/Potro-Sans-Bangla-Regular.ttf')); ?>") format("truetype");
}

@font-face {
    font-family: "Alinur Banglaborno";
    src: url("<?php echo e(asset('frontEnd/fonts/Li-Alinur-Banglaborno-Unicode.ttf')); ?>");
    src: url("<?php echo e(asset('frontEnd/fonts/Li-Alinur-Banglaborno-Unicode.ttf')); ?>?#iefix") format("embedded-opentype"), url("<?php echo e(asset('frontEnd/fonts/Li-Alinur-Banglaborno-Unicode.ttf')); ?>") format("truetype");
}
...
<?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views/frontEnd/assets/style.blade.php ENDPATH**/ ?>