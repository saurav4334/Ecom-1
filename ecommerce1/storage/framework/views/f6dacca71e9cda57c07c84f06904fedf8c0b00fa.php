                    ...
                    <table class="table table-bordered table-sm mb-0 pos-cart-table">
                        ...
                        <tbody id="cartTable">
                            ...
                            <?php $__currentLoopData = $cartinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <img height="35" src="<?php echo e(asset($value->options->image)); ?>" alt="">
                                    </td>
                                    ...
                                    <td>
                                        <input type="number"
                                               ...
                                               value="<?php echo e($value->options->product_discount); ?>"
                                               placeholder="0.00"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-2">
                            <select id="area"
                                    class="form-control form-control-sm <?php $__errorArgs = ['area'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless pos-summary-table mb-2" id="cart_details">
                            ...
                            <tr>
                                <td>Discount</td>
                                <td class="text-end">৳<?php echo e($total_discount); ?></td>
                            </tr>
                            <tr>
                                <td>Grand Total</td>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-6 mb-2 pos-product-wrapper" data-name="<?php echo e(strtolower($p->name)); ?>">
                                <div class="pos-product-card pos-add-product" data-id="<?php echo e($p->id); ?>">
                                    <span class="pos-stock-badge">Stock: <?php echo e($p->stock ?? 0); ?></span>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\backEnd\order\create.blade.php ENDPATH**/ ?>