                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        data-row-id="<?php echo e($value->rowId); ?>"
                                        data-product-id="<?php echo e($value->id); ?>"
                                        data-product-name="<?php echo e(e($value->name)); ?>"
                                        data-price="<?php echo e((float) $value->price); ?>"
                                    >
                                        <td>
                                            <img height="30" src="<?php echo e(asset($value->options->image)); ?>" alt="" />
                                        </td>
                                        <td class="cart_name"><?php echo e($value->name); ?></td>
                ...
                <div class="cart-summary">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Items</td>
                                <td><?php echo e($cartCount); ?> (qty)</td>
                            </tr>
                            <tr>
                                <td>Total</td>
                    ...
                    <a href="<?php echo e(route('customer.checkout')); ?>" class="go_cart" id="checkoutButton">
                        PROCESS TO CHECKOUT
                    </a>
                </div>
            </div>
...
(function() {
    ...
    var cartItems = [
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            ...
            item_name: <?php echo json_encode($item->name, 15, 512) ?>,
            price: <?php echo e((float) $item->price); ?>,
    ...
    var cartValue     = <?php echo e((float) $grandTotal); ?>;
    var cartItemCount = <?php echo e((int) $cartCount); ?>;
    var currency      = 'BDT';
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\frontEnd\layouts\pages\cart.blade.php ENDPATH**/ ?>