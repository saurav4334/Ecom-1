        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-list">
                                        ...
                                        <a href="<?php echo e(route('roles.show', $value->id)); ?>" class="btn btn-xs btn-info waves-effect waves-light">
                                            <i class="fe-eye"></i>
                                        </a>

                                        <a href="<?php echo e(route('roles.edit', $value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light">
                                            <i class="fe-edit-1"></i>
                                        </a>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\backEnd\roles\index.blade.php ENDPATH**/ ?>