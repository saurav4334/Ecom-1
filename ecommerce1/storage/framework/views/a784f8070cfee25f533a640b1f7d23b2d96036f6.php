...
<?php $__env->startSection('title','Childcategory Edit'); ?>
...
<div class="container-fluid">
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('childcategories.update')); ?>" method="POST" class="row" data-parsley-validate="" name="editForm"  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="subcategory_id" class="form-label">Category *</label>
                             <select class="form-select form-control select2-multiple <?php $__errorArgs = ['subcategory_id'];
                                ...
                                <optgroup >
                                    ...
                                    <option value="">== == == <?php echo e($category->name); ?> == == ==</option>
                                        <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($subcat->id); ?>" <?php if($subcat->id == $edit_data->subcategory_id): ?> selected <?php endif; ?> ><?php echo e($subcat->subcategoryName); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="childcategoryName" value="<?php echo e($edit_data->childcategoryName); ?>" id="childcategoryName" required="">
...
<script type="text/javascript">
    document.forms["editForm"].elements["childcategorytype"].value = "<?php echo e($edit_data->childcategorytype); ?>";
    document.forms["editForm"].elements["subcategory_id"].value = "<?php echo e($edit_data->subcategory_id); ?>";
</script>
<!-- /.content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\getup\Downloads\ecom2\drive-download-20260125T155433Z-1-001\ecommerce1\resources\views\backEnd\childcategory\edit.blade.php ENDPATH**/ ?>